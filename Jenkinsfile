	...
	stage('Checkout Base Image Git Repository') {
		steps {
			git branch: 'master',
				 ...
				 url: '${GERRIT_MIRROR}/OSS/ENM-Parent/SQ-Gate/com.ericsson.oss.mediation.sdk/eric-enm-fmsdk'
			sh '''
				git remote set-url origin --push ${GERRIT_CENTRAL}/OSS/ENM-Parent/SQ-Gate/com.ericsson.oss.mediation.sdk/eric-enm-fmsdk
			'''
		}
	}
